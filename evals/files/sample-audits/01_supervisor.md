...
| Evaluation | 2 | Review fixture существует, но agent-level сценарии остаются частичными. | `evals/evals.json#L225-L239`, `evals/expected-findings.md#L7-L18` |
...
- **Implicit routing contract**: Handoff между агентами не описан машинно.
...
- [ ] Смоделировать happy-path с каждым подагентом.
